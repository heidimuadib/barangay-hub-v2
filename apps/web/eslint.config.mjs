...
// `supabase/**` left this list with ADR-0007: SQL migrations and pgTAP now
// live in the backend workspace package, outside this package entirely.
const SQL_ALLOWLIST = ['src/features/*/repositories/**', 'scripts/**']
...
export default tseslint.config(
  ...
  // The generated database types moved to backend/supabase/generated with
  // ADR-0007 and are imported type-only as `@barangay-hub/supabase/types` —
  // outside this package, so no per-file override is needed here any more.
